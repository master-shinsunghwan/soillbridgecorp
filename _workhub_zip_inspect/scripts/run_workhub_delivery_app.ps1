...
$WorkhubDataDir = "Y:\CODEX\workhub"
$env:WORKHUB_DATA_DIR = $WorkhubDataDir
...
if (-not (Test-Path -LiteralPath $WorkhubDataDir)) {
  New-Item -ItemType Directory -Path $WorkhubDataDir -Force | Out-Null
}
