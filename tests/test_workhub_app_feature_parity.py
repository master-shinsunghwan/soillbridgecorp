...
class WorkhubAppFeatureParityTests(unittest.TestCase):
    ...
    def test_crm_daily_work_logs_are_available_from_work_management(self) -> None:
        ...
        self.assertIn('id="crmDailyFormSummary"', html_source)
        self.assertIn('id="crmDailyDraftButton"', html_source)
        ...
        self.assertIn("function renderCrmDailyFormSummary", html_source)
        self.assertIn("function draftCrmDailyFromTasks", html_source)
