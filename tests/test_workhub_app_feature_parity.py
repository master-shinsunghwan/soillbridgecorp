...
class WorkhubAppFeatureParityTests(unittest.TestCase):
    ...
    def test_sales_report_dashboard_layout_uses_three_report_types(self) -> None:
        ...
        self.assertIn('function dashboardRecentSalesRows(dailyRows = [], baseDateText = "", periodText = "")', html_source)
        self.assertIn('parseLocalDate(periodText ? `${periodText}-01` : "")', html_source)
