...
class WorkhubAppFeatureParityTests(unittest.TestCase):
    ...
    def test_sales_report_upload_has_dedicated_sales_workspace_mode(self) -> None:
        ...
        self.assertIn('"/api/sales-automation-settings"', html_source)
        self.assertIn('"/api/sales-automation-scan"', html_source)
        ...
        self.assertIn("function loadSalesAutomationSettings()", html_source)
        self.assertIn("function scanSalesNasNow()", html_source)
        ...
        self.assertIn('id="salesNasImportDir"', html_source)
        self.assertIn('id="salesNasScanNow"', html_source)
